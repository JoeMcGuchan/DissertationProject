...
public class ConstellationDescription : Object
{
	...
	public ConstellationDescription(
		public int[] orbitalPlanessNew 
		public int[] sattelitesPerPlanesNew;
		public int[] altitudesNew;
		public float[] inclinationsNew;
		public float[] phaseOffsetsNew;
		public LinkingMethod[] linkingMethodsNew;
